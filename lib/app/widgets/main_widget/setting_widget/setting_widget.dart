    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
            ...
            children: [
              SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    headingRowColor:
                        WidgetStateProperty.all(greyE7.withOpacity(.2)),
                    border: TableBorder(
                    ...
                    columns: [
                      ...
                      DataColumn(
                          label: Text(appText.browser, style: style14Bold())),
                      DataColumn(
                          label: Text(appText.device, style: style14Bold())),
                      DataColumn(label: Text(appText.ip, style: style14Bold())),
                    ],
                    rows: List.generate(loginHistory.length, (index) {
                      return DataRow(
                          selected: false,
                          color: WidgetStateProperty.all((index % 2 == 1)
          ...
          if (PublicData.apiConfigData?['allow_instructor_delete_content'] ??
              false) ...{
            space(16),
            Padding(
              padding: padding(),
