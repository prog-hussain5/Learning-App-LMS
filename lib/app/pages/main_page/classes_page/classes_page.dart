          ...
          child: Scaffold(
            ...
            body: !hasLogin
                ...
                : !isLoading && purchases.isEmpty
                    ? Center(
                        child: emptyState(AppAssets.noCourseEmptyStateSvg,
                            appText.noCourses, appText.noCourseClassesDesc),
                      )
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ...List.generate(isLoading ? 3 : purchases.length,
                                (index) {
                              return isLoading
                                  ...
                                  : ClassessWidget.classesItem(
                                      purchases[index].webinar == null
                                          ...
                                          : purchases[index].webinar ??
                                              CourseModel(),
                                      expired:
                                          purchases[index].expired ?? false,
                                      expiredDate:
                                          (purchases[index].expiredAt ?? 0));
                            }),
                            space(110),
                          ],
                        ),
